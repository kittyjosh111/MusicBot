...
# mysic_bot_timezone: required, timezone eg America/Los_Angeles
...
# music_bot_text_channel: optional for text message
# music_bot_voice_channel: optional for music playing